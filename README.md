...
It is possible to apply some formatting options to a row. Spout supports fonts, backgrounds, borders as well as alignment styles.
...
Background| Background color | `StyleBuilder::setBackgroundColor(Color::BLUE)`
